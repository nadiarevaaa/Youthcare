...
<section class="project-section section-gap-extra-bottom primary-soft-bg">
	<div class="container">
		<div class="row project-items project-style-three justify-content-center">
			...
			$result = mysqli_query($koneksi, "SELECT * FROM tb_donation");

			while ($row = mysqli_fetch_assoc($result)) {
				echo '<div class="col-lg-6 col-sm-10">';
				echo '<div class="project-item mb-30">';
				echo '<div class="thumb" style="background-image: url(assets/img/donation/02.jpg);"></div>';
				echo '<div class="content">';
				echo '<div class="cats">';
				echo '<a href="#">Physical Health</a>';
				echo '</div>';
				echo '<div class="content-top">';
				echo '<div class="author">';
				echo '<img src="assets/img/donation/02 - profile.jpg" alt="Thumb">';
				echo '<a href="donate-details.php?id=' . $row['id'] . '">' . $row['name'] . '</a>';
				echo '</div>';
				echo '<span class="date"><i class="far fa-calendar-alt"></i> 25 February 2021</span>';
				echo '</div>';
				echo '<h5 class="title">';
				echo '<a href="donate-details.php?id=' . $row['id'] . '">' . $row['title'] . '</a>';
				echo '</h5>';
				...
				echo '<span class="value-title">Raised of Rp' . $formattedAmount . '</span>';

				$percentage = $row['total'] / $row['target'] * 100;
				echo '<span class="stats-percentage">' . $percentage . '%</span>';

				echo '</div>';
				echo '<div class="stats-bar" data-value="' . $percentage . '">';
				echo '<div class="bar-line"></div>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
				echo '</div>';
			...
			<div class="col-12">
				<div class="view-more-btn text-center mt-40">
					<a href="donation.php" class="main-btn bordered-btn">View More Project <i class="far fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
	</div>
