        ...
        <div class="container">
            <div class="row team-members justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        <div class="member-photo">
                            <img src="assets/img/team/diva.jpg" alt="Member">
                        </div>
                        <div class="member-info">
                            <h5 class="name"><a href="#">Diva Ivani Arista P.</a></h5>
                            <span class="title">Data Entry Clerk</span>
                ...
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        <div class="member-photo">
                            <img src="assets/img/team/jihan2.jpg" alt="Member">
                        </div>
                        <div class="member-info">
                ...
                <div class="col-lg-6 col-md-6 col-sm-9">
                    <div class="member-box mb-30">
                        <div class="member-photo">
                            <img src="assets/img/team/yasmin.jpg" alt="Member">
                        </div>
                        <div class="member-info">
                            <h5 class="name"><a href="#">Saarah Muthiah Yasmin</a></h5>
